...
export default function Header2({ scroll, handlePopup, handleMobileMenu }) {
    return (
        ...
        <header className="main-header-one style2">
                            ...
                            <div className="main-menu__wrapper-inner">
                                <div className="main-header-one__bottom-left">
                                    <div className="logo-one">
                                        <Link href="/"><img src="assets/images/resources/logo-3-v2.webp" alt=""/></Link>
                                    </div>
                                </div>
        ...
        <div className={`stricky-header stricky-header--two stricked-menu main-menu ${scroll ? "stricky-fixed" : ""}`}>
