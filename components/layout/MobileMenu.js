            ...
            <div className="mobile-nav__wrapper">
                ...
                <div className="mobile-nav__content">
                    ...
                    <div className="logo-box">
                        <Link href="/" aria-label="logo image"><img src="assets/images/resources/logo-1-v2.webp" width="150" alt="" /></Link>
                    </div>
                    ...
                    <div className="mobile-nav__top">
                        <div className="mobile-nav__social">
                            ...
                            <Link href="https://www.instagram.com/shemnoc/" className="fab fa-instagram"></Link>
                        </div>
                    </div>
                </div>
            </div>
